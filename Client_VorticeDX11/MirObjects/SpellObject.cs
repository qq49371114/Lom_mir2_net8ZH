...
namespace Client.MirObjects
{
    class SpellObject : MapObject
    {
        ...
        public override void Process()
        {
            ...
            DrawLocation = new Point((CurrentLocation.X - User.Movement.X + MapControl.OffSetX) * MapControl.CellWidth + MapControl.ViewOffsetX, (CurrentLocation.Y - User.Movement.Y + MapControl.OffSetY) * MapControl.CellHeight + MapControl.ViewOffsetY);
        ...
        private Point GetDrawWithOffset()
        {
            Point newDrawLocation = new (
                (CurrentLocation.X + AnimationOffset.X - User.Movement.X + MapControl.OffSetX) * MapControl.CellWidth + MapControl.ViewOffsetX,
                (CurrentLocation.Y + AnimationOffset.Y - User.Movement.Y + MapControl.OffSetY) * MapControl.CellHeight + MapControl.ViewOffsetY);
