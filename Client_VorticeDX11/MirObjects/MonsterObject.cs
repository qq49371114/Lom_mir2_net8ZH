        ...
        public override void Process()
        {
            ...
            switch (CurrentAction)
            {
                ...
                case MirAction.刺客冲击:
                    ...
                    bool useMoveTick = CurrentAction != MirAction.弓箭跳跃 && CurrentAction != MirAction.刺客冲击;
                    OffSetMove = GetDirectionalMoveOffset(Direction, i, count, index, FrameInterval, useMoveTick, 100);

                    if (ShouldRedrawSmoothMovement(FrameInterval, useMoveTick, count, 100))
