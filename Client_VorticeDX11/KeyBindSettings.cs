namespace Client
{
    ...
    public class KeyBindSettings
    {
        ...
        public void New(List<KeyBind> list)
        {
            ...
            InputKey = new KeyBind { Group = "界面", Description = "切换 UI 布局 (Profile)", function = KeybindOptions.ToggleUIProfile, RequireAlt = 2, RequireShift = 2, RequireTilde = 2, RequireCtrl = 1, Key = Keys.F1 };
            list.Add(InputKey);
        }
