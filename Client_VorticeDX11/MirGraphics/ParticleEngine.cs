...
namespace Client.MirGraphics
{
    ...
    public class ParticleEngine
    {
        ...
        protected static int ViewWidth => Math.Max(1, MapControl.ViewPixelWidth);
        protected static int ViewHeight => Math.Max(1, MapControl.ViewPixelHeight);
            ...
            switch (type)
            {
                ...
                case ParticleType.FloatingFlower:
                    ...
                    particle = new Particle()
                    {
                        ...
                        Blend = true,
                        BlendRate = 1F,
                        Position = new Vector2(CMain.Random.Next(ViewWidth), CMain.Random.Next(ViewHeight / 4, ViewHeight * 2)),
                ...
                case ParticleType.BlizzardFrost:
                    ...
                    particle = new Particle()
                    {
                        ...
                        Blend = false,
                        BlendRate = 0.35F,
                        Position = new Vector2(CMain.Random.Next(ViewWidth), CMain.Random.Next(ViewHeight / 2, ViewHeight)),
