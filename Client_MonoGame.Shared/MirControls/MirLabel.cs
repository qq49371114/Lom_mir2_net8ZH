...
namespace MonoShare.MirControls
{
    public class MirLabel : MirControl
    {
        ...
        protected override void CreateTexture()
        {
            ...
            var font = CMain.fontSystem.GetFont(14);
            CMain.spriteBatch.DrawString(font, Text, new Microsoft.Xna.Framework.Vector2(Location.X, Location.Y), Microsoft.Xna.Framework.Color.White);
